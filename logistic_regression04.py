...
"""
본 코드는 Colab 환경에서 실행. dataset 을 google drive 에 업로드하고 google drive 를 Colab 에 mount
아니면 로컬에서 해당 dataset load 해서 진행 가능 -> # Training Data 생성 부분부터 시작하면 됨
"""

drive.mount('/content/gdrive')  # colab 의 /content/gdrive 에 google drive 를 마운트 시킴
